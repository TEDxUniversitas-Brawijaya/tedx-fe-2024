...
export default function Section3() {
  ...
  const opacityFilter = useTransform(scrollYProgress, [0.7, 0.75], [0, 0.6]);
  ...
  const opacityText3 = useTransform(
    scrollYProgress,
    [0, 0.65, 0.7, 0.75, 0.8, 0.825, 0.85, 0.875, 0.9],
    [0, 0, 0, 0, 0, 0, 1, 1, 0],
  );
  const opacityText4 = useTransform(
    scrollYProgress,
    [0, 0.65, 0.7, 0.75, 0.8, 0.825, 0.85, 0.875, 0.9, 0.95, 1],
  ...
  return (
    <section className="text-tedx-white relative -z-20 h-[500vh]">
      <div className="sticky top-0 flex h-screen w-full flex-col items-center pt-52 text-center">
        ...
        <motion.div
          className="absolute z-20 w-1/2 text-lg font-semibold opacity-0"
