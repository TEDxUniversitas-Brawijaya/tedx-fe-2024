...
export default function MobileSection1() {
  ...
  return (
    <section
      className="bg-tedx-grey-300 relative z-0 flex min-h-screen flex-col items-center justify-center gap-10 overflow-hidden px-5 pt-20 text-center"
    ...
    >
      ...
      <div className="z-10">
        <p className="text-lg text-tedx-red">
          Swara berarti suara; Aksara berarti huruf
        </p>
        <h2 className="font-header text-5xl font-bold md:text-6xl">
          Swara Aksara
        </h2>
      </div>
