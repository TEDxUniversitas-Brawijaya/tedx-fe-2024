...
import FormMerchBundling from "../ui/form-merch-bundling";
...
const ClientFormMerchBundlingPage = ({ item, merch }: IClientFormMerchPage) => {
    ...
    create: (
      <>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <DialogDetailItem
            label="Varian"
            value={`${dialogState.data?.item1} + ${dialogState.data?.item2}`}
          />
          <DialogDetailItem
            label="Email"
            capitalize={false}
...
export default ClientFormMerchBundlingPage;
